    ...
    Column {
        ...
        LaunchedEffect(key1 = textValue.value, block = {
            ...
            if (textValue.value.isEmpty()) {
                errorValue.value = context.getString(R.string.confirm_password_cant_empty)
            } else if (textValue.value.count() < 6) {
                errorValue.value = context.getString(R.string.confirm_password_minimum)
            } else if (textValue.value != valuePassword) {
                errorValue.value = context.getString(R.string.confirm_password_dont_match)
            }
